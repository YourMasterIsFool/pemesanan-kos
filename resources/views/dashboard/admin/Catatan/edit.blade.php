...
@section('content')
    <div class="container">
        <h2 class="black" style="margin-bottom: 20px;">Edit Catatan</h2>
        <div class="bg-4" style="padding: 10px; border-radius: 5px;">
            <form method="POST" action="{{ route('admin.catatan.edit.save', $catatan->id) }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input id="nama" type="text"
                                    ...
                                    value="{{ $catatan->nama }}" autocomplete="username" required>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input id="nomor_kamar" type="text"
                                    ...
                                    value="{{ $catatan->nomor_kamar }}" autocomplete="username" required>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input id="bulan" type="text"
                                    ...
                                    value="{{ $catatan->bulan }}" autocomplete="bulan" required>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input id="jumlah" type="number"
                                    ...
                                    value="{{ $catatan->jumlah }}" autocomplete="username" required>
