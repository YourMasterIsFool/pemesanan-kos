...
@section('content')
    <div class="container">
        <h2 class="black" style="margin-bottom: 20px;">Edit Pemilik</h2>
        <div class="bg-4" style="padding: 10px; border-radius: 5px;">
            <form method="POST" action="{{ route('dashboard.daftarpemilik.editsave', $pemilik->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="double_form">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input id="nama" type="text"
                                    ...
                                    value="{{$pemilik->nama}}" autocomplete="username">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input id="alamat" type="text"
                                    ...
                                    value="{{$pemilik->alamat}}" autocomplete="username">
                    ...
                    <div class="right">
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input id="no_telepon" type="number"
                                    ...
                                    value="{{$pemilik->nomor_telepon}}" autocomplete="no_telepon">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input id="email" type="text"
                                    ...
                                    value="{{$pemilik->email}}" autocomplete="username">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <label for="password" class="font-1">Password Baru ( opsional )</label>
